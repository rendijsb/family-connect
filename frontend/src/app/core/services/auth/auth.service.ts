...
export class AuthService {
  ...
  // ✅ FIXED: Safe user access methods with proper error handling
  user(): User | null {
    try {
      // Ensure _currentUser is a signal function
  ...
  // ✅ FIXED: Add method for components that might have the old pattern
